...
// Fetch products from database with search query
        ...
        function redirectToDashboard() {
            <?php if (isset($_SESSION['user_role'])): ?>
                ...
                if (userRole === 'admin') {
                    ...
                    window.location.href = 'login.html'; // Redirect to login if role is not recognized
                }
            <?php else: ?>
                window.location.href = 'login.html'; // Redirect to login if session is not set
            <?php endif; ?>
        }
